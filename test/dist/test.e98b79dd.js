...
var eventQueue = [];
var JS_DEFER_EVENT = 'js-defer-event';
/**
...
var _onNotifyEvent = function _onNotifyEvent(event) {
  if (event.source != window || event.data != JS_DEFER_EVENT) return;
...
var jsDefer = require('../index');

var init = jsDefer.init,
    defer = jsDefer.defer;
init(window);
defer(function () {
...
},{"../index":"../index.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
